...
import com.tvbogiapp.projectmanag.activities.TaskListActivity
...
open class TaskListItemAdapter (
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder,
        ...
        if(holder is MyViewHolder){
            ...
            holder.itemView.tv_task_list_tile.text = model.title
            ...
            holder.itemView.ib_close_editable_name.setOnClickListener {
            ...
            holder.itemView.ib_done_card_name.setOnClickListener {
                val cardName = holder
                    .itemView.et_card_name.text.toString()
